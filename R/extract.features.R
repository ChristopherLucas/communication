...
<<<<<<< HEAD
#' @param filenames \code{character}. The list of paths and file names. For example, "folder/1.wav"
=======
#' @param filenames \code{character}. The path and file name. For example, "folder/1.wav"
>>>>>>> eadaa1871d3086e35138f278fc69e2c279d34b38
...
#' @param speeches Vector of speeches.
=======
