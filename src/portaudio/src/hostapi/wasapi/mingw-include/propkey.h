...
//  Type:     Any -- VT_nullptr  Legacy code may treat this as VT_UNKNOWN.
...
//  Type:     Multivalue Any -- VT_VECTOR | VT_nullptr  (For variants: VT_ARRAY | VT_nullptr)
