...
int cOpenCVSource::myTick(long long t)
{
	...
	timeval grabFrame;
	gettimeofday(&grabFrame, nullptr);
	...
	if( !mCurrentFrame_bgr.empty() )
	{
		...
		gettimeofday(&convertColor, nullptr);
