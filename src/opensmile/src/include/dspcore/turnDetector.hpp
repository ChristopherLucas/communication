...
typedef void (*SetWaveFrameBordersCB_Ptr)(void *, const double &, const double &);
...
class  cTurnDetector : public cDataProcessor {
  ...
  protected:
    ...
    SetWaveFrameBordersCB_Ptr setWaveFrameBordersCB {nullptr};
...
//    virtual int processVectorFloat(const FLOAT_DMEM *src, FLOAT_DMEM *dst, long Nsrc, long Ndst, int idxi);
  ...
  public:
    ...
    void connectSetWaveFrameBordersCB(SetWaveFrameBordersCB_Ptr setWaveFrameBordersCB_);
