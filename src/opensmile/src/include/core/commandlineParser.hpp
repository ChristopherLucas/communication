...
class  cCommandlineParser {
  ...
  public:
    ...
    int addStr(const char *name, char abbr, const char *description, const char *dflt=nullptr, int argMandatory=1, int isMandatory=0 );

    void showUsage(const char *binname=nullptr);
