...
/*
    ...
    */
    ...
    int setFieldInfo(int i, int _dataType, void *_info=nullptr, long _infoSize=0) { // special value for i : -1 , last field that was added (N-1)
      if (i==-1) {
    ...
    int setFieldInfo(const char* __name, int _dataType, void *_info=nullptr, long _infoSize=0) {
...
// TODO: meta-data handling...
    ...
    const char * getFieldName(int n, int *lN = nullptr)
    { 
