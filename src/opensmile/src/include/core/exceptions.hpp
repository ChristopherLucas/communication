...
class  cComponentException : public cSMILException {
  ...
  public:
    cComponentException(char *t, const char *m=nullptr):
      cSMILException(EX_COMPONENT),
      tmp(nullptr),
      text(nullptr)
      { module=m; text=t; logException(); }
    cComponentException(int _type, char *t, const char *m=nullptr):
    ...
    virtual void logException() {
      ...
      SMILE_LOG_GLOBAL.error_smile(text,1,module);
      text = nullptr;
      #endif
      #endif
    }
...
class  cConfigException : public cComponentException {
  ...
  public:
    cConfigException(int _origin, char *t, const char *m=nullptr) :
...
class  cIOException : public cComponentException {
  public:
    cIOException(char *t, int _code=0, const char *m=nullptr) :
...
class  cUserException : public cComponentException {
  public:
    cUserException(char *t, int _code, const char *m=nullptr) :
