...
SMILECOMPONENT_REGCOMP(cCsvSink)
{
  ...
  SMILECOMPONENT_IFNOTREGAGAIN_BEGIN
    ...
    ct->setField("instanceBase", "if not empty, print instance name attribute <instanceBase_Nr>", (const char*)nullptr);
    ct->setField("instanceName", "if not empty, print instance name attribute <instanceName>", (const char*)nullptr);
